    ...
    <div class="col-lg-6 col-xl-6">
        <form action="{{ route('new') }}" method="POST" class="form-modals border rounded border-dark d-flex flex-column align-items-md-center p-4 mt-5">
            ...
            <div class="form-group col-12 d-flex align-items-center justify-content-between p-0">
                ...
                <input class="form-control p-2 @error('name')is-invalid @enderror" type="text" name="name" required="" value="{{ old('name') }}">
            </div>
            <div class="form-group col-12 d-flex align-items-center justify-content-between p-0">
                <label class="mb-0 ml-auto mr-1" for="">Телефон</label>
                <input class="form-control p-2 @error('phone')is-invalid @enderror" type="number" name="phone" value="{{ old('phone') }}">
            </div>
            <div class="form-group col-12 d-flex align-items-center justify-content-between p-0">
                <label class="mb-0 ml-auto mr-1" for="">Email</label>
                <input class="form-control p-2 @error('email')is-invalid @enderror" type="email" name="email" value="{{ old('email') }}">
            </div>
